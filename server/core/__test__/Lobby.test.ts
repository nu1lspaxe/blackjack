...
// import { createTable, joinTable, tables } from '@core/Lobby';
...
//         expect(table!.playerLen()).toBe(1);

//         const player = table!.playerInfo(0);
//     });
// });
